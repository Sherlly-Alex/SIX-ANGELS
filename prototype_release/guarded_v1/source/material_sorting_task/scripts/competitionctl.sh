...
The default client mode is heuristic (MATERIAL_SCHEDULER_RL_ENABLED=0).
...
case "${1:-}" in
  preflight) preflight "${2:-heuristic}" ;;
  ...
  client) require_run "${2:-}"; run_client "$2" "${3:-heuristic}" ;;
