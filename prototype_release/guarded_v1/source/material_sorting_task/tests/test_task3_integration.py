...
class Task3IntegrationWiringTests(unittest.TestCase):
    ...
    def test_executor_derives_release_from_shared_shelf_snapshot(self) -> None:
        ...
        self.assertAlmostEqual(executor._place_world[1], 0.555, places=6)
        self.assertAlmostEqual(
            executor._task3_release_lateral_inset_m, 0.015, places=6
        )
    ...
    def test_executor_uses_each_rounds_formal_place_radius(self) -> None:
        ...
        # Preserve the original radial budget while halving the inward seat.
    ...
    def test_release_keeps_formal_lateral_clearance_from_prop(self) -> None:
        ...
        self.assertEqual(executor._task3_release_lateral_inset_m, 0.015)
        self.assertAlmostEqual(executor._place_world[1], 0.605, places=6)
