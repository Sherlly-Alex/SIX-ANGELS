...
contact IK and freezes on stable bilateral effort feedback from the official
...
placement, an explicit safe shelf-front pre-place route that preserves the
held arm pose, and safe retreat/retraction.
