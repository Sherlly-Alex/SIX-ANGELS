...
REQUIRED = (
    ...
    TASK / "executors" / "local_map_motion.py",
    ...
    TASK / "navigation" / "carried_envelope.py",
    TASK / "navigation" / "task3_lateral_safety.py",
    TASK / "perception" / "box_detect.py",
    TASK / "perception" / "depth_geometry.py",
    TASK / "perception" / "local_map.py",
    TASK / "perception" / "local_map_sidecar.py",
    ...
    ROOT / "scripts" / "demo_local_map.py",
