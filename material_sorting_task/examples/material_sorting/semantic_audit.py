...
class SemanticAudit:
    ...
    def __init__(self, log: Callable[[str], None]) -> None:
        ...
        self._slm_timeout_s = float(
            os.environ.get("MATERIAL_SEMANTIC_AUDIT_SLM_TIMEOUT_S", "30")
        )
        self._slm_weights = os.environ.get("MATERIAL_SEMANTIC_AUDIT_SLM_WEIGHTS")
        self._executor = ThreadPoolExecutor(max_workers=1, thread_name_prefix="semantic-audit")
