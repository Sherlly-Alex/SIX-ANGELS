...
最新版官方镜像不发布 `/material/unsafe_collision`；客户端使用本地几何安全检查，
并从官方 `/joint_states` 的 effort 数组判断接触载荷。
...
双臂关节力矩接触证据必须连续稳定 0.30 秒；首次检测到双侧接触时会立即冻结
