...
RL-2 默认关闭、成功率优先的运行边界见
[docs/RL2_SUCCESS_FIRST.md](docs/RL2_SUCCESS_FIRST.md)。远程8路仿真采集、单路官方
Server采集、6候选训练、500种子盲测和一键回退命令见
[docs/RL2_REMOTE_EXECUTION.md](docs/RL2_REMOTE_EXECUTION.md)。
